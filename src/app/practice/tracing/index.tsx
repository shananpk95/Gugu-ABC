...
const SCENE_ASPECT = 1100 / 968;

const SUBCATEGORIES = [
  {
    id: 'uppercase',
    label: 'Capital letters',
    href: '/practice/tracing/uppercase' as Href,
    icon: require('@/assets/images/subcat-uppercase.png'),
  },
  {
    id: 'lowercase',
    label: 'Small letters',
    href: '/practice/tracing/lowercase' as Href,
    icon: require('@/assets/images/subcat-lowercase.png'),
  },
] as const;

export default function TracingHubScreen() {
  ...
  const sceneHFromW = sceneMaxW * SCENE_ASPECT;
  const sceneHeight = Math.min(sceneMaxH, sceneHFromW);
  const sceneWidth = sceneHeight / SCENE_ASPECT;
      ...
      <View style={styles.split}>
        <View style={[styles.left, { width: leftWidth, paddingLeft: padLeft, paddingTop: padTop, paddingBottom: padBottom }]}>
          ...
          <View style={styles.boyStage} pointerEvents="none">
            <Image
              source={require('@/assets/images/gugu-boy-board.png')}
